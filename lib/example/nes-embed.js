...
function onAnimationFrame(){
	...
	if (frameCount % 1 === 0){
		...
		var stairs2start = 720 - (SCREEN_HEIGHT / 2) - 10
		var stairs2end = 752 - (SCREEN_HEIGHT / 2) - 10

		var stairs3start = 913 - (SCREEN_HEIGHT / 2) - 10
		var stairs3end = 944 - (SCREEN_HEIGHT / 2) - 10

		var stairs4start = 1297 - (SCREEN_HEIGHT / 2) - 10
		var stairs4end = 1392 - (SCREEN_HEIGHT / 2) - 10
		...
		if (levelOffset > stairs2start && levelOffset < stairs2end){
			yoffset = -63 + (levelOffset - stairs2start) * -1
		}

		if (levelOffset > stairs3start && levelOffset < stairs3end){
			yoffset = -94 - (levelOffset - stairs3start) * -1
		}

		// floor 1
		if (levelOffset > 1025 - (SCREEN_HEIGHT / 2) - 10){
			yoffset = 0
		}

		if (levelOffset > stairs4start && levelOffset < stairs4end){
			yoffset = (levelOffset - stairs4start) * -1
		}

		// raised
		
		if (levelOffset >= stairs4end){
			yoffset = -94
		}
